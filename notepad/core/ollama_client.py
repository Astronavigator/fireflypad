...
1. Составь список потенциальных поисковых запросов,
которые помогут найти именно эту заметку среди других 
(т.е. запросов которые пользователь возможно будет задавать системе, 
 когда ему будет нужно найти эту заметку среди множества других)
Запросы должны быть максимально разнообразны по формулировке. Не перефразируй один и тот же запрос.
